...
//
//    ⭑ THE PAD KNOBS ARE FOUR SIBLING LEVELS (Sample / Shape / Mix / Stereo), one
//    per bank, sharing one focus. (Stereo holds Wide, 2026-09-22.) They must agree about the children they address,
//    or two banks are editing two different pads while showing one pad number.
const PAD_LEVELS = ['pads', 'pad_shape', 'pad_mix', 'pad_stereo'];
